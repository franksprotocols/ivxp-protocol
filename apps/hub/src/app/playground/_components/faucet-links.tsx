  ...
  return (
    <Card data-testid="faucet-links">
      <CardHeader>
        ...
        <CardDescription>You need Base Sepolia ETH and USDC to test the protocol</CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          <h4 className="font-medium">Base Sepolia ETH</h4>
          <p className="text-sm text-muted-foreground">Required for gas fees</p>
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Required for paying for services</p>
          <Button asChild variant="outline" className="mt-2">
            <a
