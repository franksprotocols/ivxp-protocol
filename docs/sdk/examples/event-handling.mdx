...
description: Demonstrates subscribing to SDK events for monitoring the service request lifecycle using the IVXP client's event emitter.
---

# Event Handling

Demonstrates subscribing to SDK events for monitoring the service request lifecycle.
