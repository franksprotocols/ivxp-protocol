...
description: Demonstrates handling various SDK error types and implementing recovery strategies when calling IVXP services.
---

# Error Recovery

Demonstrates handling various SDK error types and implementing recovery strategies.
